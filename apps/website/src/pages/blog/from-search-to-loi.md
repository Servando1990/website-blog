...
<p class="blog-subtitle">Why Private Capital Needs Workflow Agents</p>

<figure class="blog-lead-image">
  <img src="/blog/search-to-loi-image.jpg" alt="Pink flowers growing across a textured stone wall." loading="eager" decoding="async" />
</figure>
...
One example I've been following is [Yellowwood](https://www.yellowwood.ai/), which fits the downstream triage pattern: helping investors move from inbound opportunity to thesis-fit assessment, visible gaps, verification, and next action without turning every deck into full diligence.
